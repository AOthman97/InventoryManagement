...
var InventoryManagementContext = scope.ServiceProvider.GetRequiredService<InventoryManagementDBContext>();
InventoryManagementContext.Database.EnsureDeleted();
InventoryManagementContext.Database.EnsureCreated();
